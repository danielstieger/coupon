...
<solution name="at.hafina.coupon" uuid="989fa659-ba46-402d-a8cd-d866cf8bfe22" moduleVersion="0" compileInMPS="true">
  <models>
    <modelRoot contentPath="${module}" type="default">
      <sourceRoot location="models" />
    </modelRoot>
    <modelRoot contentPath="${APPHome}/coupon/jars" type="java_classes">
      <sourceRoot location="mysql-connector-java-8.0.11.jar" />
    </modelRoot>
  </models>
  <stubModelEntries>
    <stubModelEntry path="${APPHome}/coupon/jars/mysql-connector-java-8.0.11.jar" />
  </stubModelEntries>
  <sourcePath />
  <dependencies>
  ...
  <dependencyVersions>
    ...
    <module reference="989fa659-ba46-402d-a8cd-d866cf8bfe22(at.hafina.coupon)" version="0" />
